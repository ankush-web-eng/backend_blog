...
app.get("/blog", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1.default.get("".concat(process.env.URL, "/api/ghost/getallghosts"))];
            case 1:
                response = _a.sent();
                res.json({
...
app.get("/blog/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, axios_1.default.get("".concat(process.env.URL, "/api/ghost/getghost/").concat(id))];
            case 2:
                response = _a.sent();
                res.json({
                    message: response.data
